...
@implementation UIViewController (LHNavigationController)
@dynamic lhNavigationController;

- (LHNavigationController *)lhNavigationController
{
    
    if([self.parentViewController isKindOfClass:[LHNavigationController class]])
    {
        return (LHNavigationController*)self.parentViewController;
    }
    else if([self.parentViewController isKindOfClass:[UINavigationController class]] &&
            [self.parentViewController.parentViewController isKindOfClass:[LHNavigationController class]])
    {
        return (LHNavigationController*)[self.parentViewController parentViewController];
    }
    else
    {
        return nil;
